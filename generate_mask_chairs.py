...
from data_loader_bgfg_2 import chairs
...
dataset = chairs(imfile= opt.train_imgs, mfiles = allmasks,  category_names = category_names, transform=transform, final_img_size=img_size)
