...
class CocoData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for i in range(1):
            ...
            print(instance['bbox'])
            #### Added for bbox 
#             x_1, y_1, width, height = instance['bbox'] 
#             x_2, y_2 = x_1 + width, y_1 + height
#             bbox = Image.new('L', (img_size_x, img_size_y))
#             ImageDraw.Draw(bbox).polygon([x_1, y_1, x_1, y_2, x_2, y_2, x_1, y_2], outline=1, fill=1)
            bbox = instance['bbox']
        ...
        sample = {'image': img, 'seg_mask': seg_masks, 'cat': self.cat[index], 'num_object':num_object,'id':img_id, 'bboxes': bbox_mask, 'bbox':instance['bbox'] }
        return sample
